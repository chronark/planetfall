...
import FeaturesImage from "../../public/landing/features-02.png";
import Illustration from "../../public/landing/features-illustration.svg";

export const Features02: React.FC = (): JSX.Element => {
  return (
