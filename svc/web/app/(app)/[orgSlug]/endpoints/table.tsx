...
export const EndpointsTable: React.FC<Props> = ({ endpoints }) => {
    ...
    const countFormat = (n: number) => Intl.NumberFormat(undefined, { maximumFractionDigits: 1, notation: "compact" }).format(n)
    const latencyFormat = (n: number) => `${Intl.NumberFormat(undefined, { maximumFractionDigits: 1 }).format(n)} ms`
