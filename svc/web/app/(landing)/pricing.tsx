...
const Button: React.FC<PropsWithChildren<{ href: string }>> = ({ children, href }) => {
  return <Link href={href} className="block w-full py-2 text-sm font-semibold text-center duration-500 border rounded bg-zinc-100 text-zinc-700 hover:bg-zinc-50 hover:text-zinc-900 hover:drop-shadow-cta focus:bg-zinc-900 focus:text-zinc-50 focus:drop-shadow-none border-zinc-100">
    {children}
  </Link >
}
