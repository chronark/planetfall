...
import { MobileNavigation } from "docs-components/MobileNavigation";
import { Navigation } from "docs-components/Navigation";
import { Prose } from "docs-components/Prose";
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center gap-4">
        ...
        <Link
          href="/docs"
          className="text-primary-500 hover:text-primary-700 dark:text-primary-100 hover:dark:text-white px-2 py-1 rounded font-semibold"
        >
          Docs
        </Link>
      </div>
