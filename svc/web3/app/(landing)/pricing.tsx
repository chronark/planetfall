              ...
              {tiers.map((tier, tierIdx) => (
                <section key={tier.name} className="lg:w-1/5">
                  <div className="mb-8 px-4">
                    ...
                    <a
                      href={tier.href}
                      className="mt-6 block w-full rounded border border-slate-100 bg-slate-800 py-2 text-center text-sm font-semibold text-white hover:bg-slate-900"
                    >
                      {tier.cta}
                    </a>
                  </div>
                  ...
                  >
                    <a
                      href={tier.href}
                      className="block w-full rounded border border-slate-100 duration-300 bg-slate-800 py-2 text-center text-sm font-semibold text-white hover:bg-slate-50 hover:text-slate-900"
                    >
                      {tier.cta}
                    </a>
                  </div>
            ...
            <div className="hidden lg:block">
              <table className="h-px w-full table-fixed">
                ...
                <thead>
                  <tr>
                    <th
                      className="px-6 pb-4 text-left text-sm font-medium text-slate-100"
                      scope="col"
                    >
                    ...
                    {tiers.map((tier) => (
                      <th
                        key={tier.name}
                        className="lg:w-1/5 px-6 pb-4 text-left text-lg font-medium leading-6 text-slate-100"
                        scope="col"
                      >
                        {tier.name}
                      </th>
