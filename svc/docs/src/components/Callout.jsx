...
const styles = {
  note: {
    ...
    body:
      "text-primary-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-primary-900 prose-code:text-primary-900 dark:text-slate-300 dark:prose-code:text-slate-300",
  },
  warning: {
    container:
