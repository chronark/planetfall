...
var Scheduler = /** @class */ (function () {
    ...
    Scheduler.prototype.syncEndpoints = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, endpoints, wantIds, _a, _b, endpointId, endpoints_1, endpoints_1_1, endpoint;
            var e_1, _c, e_2, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        now = Date.now();
                        return [4 /*yield*/, this.db.endpoint.findMany({
                                where: {
                                    active: true
                                }
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(endpoint.regions.map(function (regionId) { return __awaiter(_this, void 0, void 0, function () {
                                var region, time, res, _a, _b, _c, body, _d, status, latency;
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0: return [4 /*yield*/, this.db.region.findUnique({
                                                where: { id: regionId }
                                            })];
                                        case 1:
                                            region = _e.sent();
                                            if (!region) {
                                                throw new Error("region not found: ".concat(regionId));
                                            }
