      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4, /*yield*/
              c.connect()["catch"](function (err) {
                throw new Error(
                  "unable to connect to kafka: ".concat(err.message),
                );
              }),
            ];
          case 1:
            ...
            return [
              4, /*yield*/
              c.subscribe({ topic: "endpoint.created", fromBeginning: false }),
            ];
          case 2:
            _a.sent();
            return [
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 1:
                          return [
                            4, /*yield*/
                            this.scheduler.addEndpoint(endpointId),
                          ];
                        case 2:
                          _c.sent();
                          return [3, /*break*/ 7];
                        ...
                        case 5:
                          ...
                          return [3, /*break*/ 7];
                        case 6:
                          throw new Error("unknown topic: ".concat(topic));
                        case 7:
                          return [2 /*return*/];
                      }
                    });
