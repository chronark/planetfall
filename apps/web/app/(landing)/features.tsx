...

    {
      ...
      bullets: [
        ...
        },
        {
          ...
          description: "Receive real-time alerts for potential performance issues.",
        },
        {
          icon: Webhook,
          title: "Channels.",
          description: "Receive alerts via Email, Webhook, Slack, Discord or Opsgenie.",
        },
      ],
    },
    {
      ...
      description: "Create custom status pages for your APIs to share with your customers.",
      ...
      bullets: [
        ...
        },
        {
          ...
          description: "Show historical data on API performance to provide a complete picture.",
        },
        {
          icon: Globe,
