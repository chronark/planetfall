...
>(({ className, ...props }, ref) => (
	...
	>
		<SwitchPrimitives.Thumb
			className={cn(
				"pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg  transition-transform data-[state=unchecked]:tranzinc-x-0 data-[state=checked]:tranzinc-x-5",
			)}
		/>
	</SwitchPrimitives.Root>
));
