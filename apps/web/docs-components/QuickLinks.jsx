...
export function QuickLink({ title, description, href, icon }) {
	return (
		<div className="relative border group rounded-xl border-zinc-200 dark:border-zinc-800">
			...
			<div className="relative p-6 overflow-hidden rounded-xl">
				...
				<h2 className="mt-4 text-base font-display text-zinc-900 dark:text-white">
					<Link href={href}>
